...
const Comments = (rating_id) =>{
    ...
    const retrieveComments = () => {
        ...
        console.log(params);
        CommentService.getCommentsFromStartupID(params)
            .then((response) => {
    ...
    return(
        ...
        <Comment.Group className={"container"}>
            ...
            <div>
                { (user) ? (
                    <div>
                        <EditComment trigger={showUpdateCommentForm}  comment_id={selectedComment} setTrigger ={SetShowUpdateCommentForm} updateCommentList={retrieveComments}></EditComment>
                    </div>
                ): ""}
            </div>
        </div>
